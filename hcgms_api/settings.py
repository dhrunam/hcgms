"""
Django settings for hcgms_api project.
...
WSGI_APPLICATION = 'hcgms_api.wsgi.application'
...
REST_DURIN = {
    ...
    "USER_SERIALIZER": 'hcgms_api.account.serializers.LeanUserSerializer',
